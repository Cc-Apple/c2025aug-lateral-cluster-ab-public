...
既定出力:
  [RESULT_ROOT]\48_lateral_cluster_ab_final_seal

使い方:
  python 48_lateral_cluster_ab_final_seal.py
  python 48_lateral_cluster_ab_final_seal.py "[RESULT_ROOT]"
"""
...
def main() -> int:
    ...
    if len(sys.argv) >= 2:
        ...
        result_root = Path(os.environ.get("RESULT_ROOT", r"[RESULT_ROOT]"))
