...
Output:
  [RESULT_ROOT]\46_evidence_preservation_suppression_review
...
def main() -> int:
    ...
    ap.add_argument('--in45', default=r'[RESULT_ROOT]\45_proximity_vs_cloud_separation_review')
    ap.add_argument('--out', default=r'[RESULT_ROOT]\46_evidence_preservation_suppression_review')
    args = ap.parse_args()
